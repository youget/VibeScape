        ...
        <div className="fixed top-14 left-0 right-0 z-50 px-4 py-2">
          <div className="vs-card border vs-border rounded-xl p-3 flex items-center gap-3 max-w-5xl mx-auto shadow-lg">
            ...
            <div className="flex-1">
              <p className="text-xs font-bold vs-text">Add VibeScape to home screen</p>
              <p className="text-[10px] vs-text-sub">Quick access, app-like experience</p>
            </div>
            <button onClick={handleInstall} className="vs-btn px-3 py-1.5 rounded-lg text-[10px] font-bold">Install</button>
            <button onClick={dismissBanner} className="vs-text-sub p-1"><X size={14} /></button>
          </div>
        </div>
      )}
